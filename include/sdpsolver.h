...
extern "C" {
  ...
  void addSparse(SparseSOSblock *const block, const int index,  const coef_t value);

  Sparseblock * createblock( const int bnum, const int consnum,const  ArrangeMatrix *s);
  /* 
   * ===  FUNCTION  ======================================================================
  ...
  void wellform(SOSProblem *const sys,const int sep, const int sosMId[], const int sosMap[], const int  blockSize[],  const int blockMap[],Blockmatrix  *X);
