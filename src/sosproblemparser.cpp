...
static const yytype_uint16 yyrline[] = {
    ...
    260, 270, 280, 288, 297, 303, 311, 321, 327, 335, 344, 353, 361, 368,
    376, 383, 397, 400, 405, 411, 420, 426, 435, 441, 448, 455, 462, 480,
    509, 542, 584, 592, 627, 640, 651, 667, 679, 693, 706, 718, 732, 736,
    746, 758, 775, 787, 799, 811, 824, 835, 848, 860, 871, 875, 886, 898};
#endif
...
#line 229 "src/sosproblemparser.y" /* yacc.c:1646  */
    {
      ...
      int varIndex =
          getVarTable<indice_t>().findVarIndex((yyvsp[0].identifier));
...
#line 246 "src/sosproblemparser.y" /* yacc.c:1646  */
    {
      ...
      (yyval.iVec) = new vector<int>();
      int varIndex =
          getVarTable<indice_t>().findVarIndex((yyvsp[-2].identifier));
...
#line 543 "src/sosproblemparser.y" /* yacc.c:1646  */
    {
      ...
      for (i = 0; i < (yyvsp[0].prob)->size(); i++) {
        (yyval.prob)
            ->addElem((yyvsp[0].prob)->getPoly(i),
                      (yyvsp[0].prob)->getPolyConstraint(i));
...
#line 593 "src/sosproblemparser.y" /* yacc.c:1646  */
    {
      ...
      for (i = 0; i < (yyvsp[-1].prob)->size(); i++) {
        (yyvsp[-3].prob)
            ->addElem((yyvsp[-1].prob)->getPoly(i),
                      (yyvsp[-1].prob)->getPolyConstraint(i));
      }
