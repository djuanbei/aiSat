  ...
  do {
    ...
    if (matno == 1) {
      switch (pZ->blocks[blkno].blockcategory) {
        ...
        case MATRIX:
          pZ->blocks[blkno]
              .data.mat[ijtok(indexi, indexj, pZ->blocks[blkno].blocksize)] =
              ent;
          pZ->blocks[blkno]
              .data.mat[ijtok(indexj, indexi, pZ->blocks[blkno].blocksize)] =
              ent;
          break;
        default:
      ...
      switch (pX->blocks[blkno].blockcategory) {
        ...
        case MATRIX:
          pX->blocks[blkno]
              .data.mat[ijtok(indexi, indexj, pX->blocks[blkno].blocksize)] =
              ent;
          pX->blocks[blkno]
              .data.mat[ijtok(indexj, indexi, pX->blocks[blkno].blocksize)] =
              ent;
          break;
        default:
          printf("Illegal block type! \n");
