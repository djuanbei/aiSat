...
static int reduceByPlane1(indice_t* candidateSet, const int length,
...
static int reduceByPlane2(indice_t* candidateSet, const int length,
                          const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
static int reduceByPlane3(indice_t* candidateSet, const int length,
                          const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
static int reduceByPlane4(indice_t* candidateSet, const int length,
                          const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
static int reduceByPlane5(indice_t* candidateSet, const int length,
                          const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
static int reduceByPlane6(indice_t* candidateSet, const int length,
                          const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
static int reduceByPlane7(indice_t* candidateSet, const int length,
                          const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
static int reduceByPlane8(indice_t* candidateSet, const int length,
                          const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
static int reduceByPlane9(indice_t* candidateSet, const int length,
                          const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
static int reduceByPlane10(indice_t* candidateSet, const int length,
                           const int dim, const int* coefs, int maxSum) {
  int i;
  int tempSum = 0;
  int len = length;
...
/** 
 * @brief reduce the point in candidateSet whose sum of index less or equal to maxSum
 * 
 * @param candidateSet 
 * @param length 
 * @param dim 
 ...
 * @return 
 */
static int reduceByPlane(indice_t* candidateSet, const int length,
                         const int dim, const int* coefs, int maxSum) {
  int i, j;
  int tempSum = 0;
  int len = length;
